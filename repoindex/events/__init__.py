...
- release: Forge releases (--forge, via GitForge.fetch_events)
- pull_request: Forge pull requests (--forge, via GitForge.fetch_events)
- issue: Forge issues (--forge, via GitForge.fetch_events)
...
ALL_EVENT_TYPES = (
    LOCAL_EVENT_TYPES + LOCAL_METADATA_EVENT_TYPES + FORGE_EVENT_TYPES +
