...
from repoindex.infra.pypi_metadata import (
    detect_pypi_package,
    check_pypi_package,
    is_package_outdated,
...
class TestCheckPypiPackage(unittest.TestCase):
    ...
    @patch('repoindex.infra.pypi_metadata.requests.get')
...
class TestIsPackageOutdated(unittest.TestCase):
    ...
    @patch('repoindex.infra.pypi_metadata.check_pypi_package')
    @patch('repoindex.infra.pypi_metadata.get_local_package_version')
...
"""
        ...
        from repoindex.infra.pypi_metadata import get_local_package_version
...
class TestPackageVersionComparison(unittest.TestCase):
    ...
    def test_package_is_outdated_local_older(self, mock_get_local):
        ...
        from repoindex.infra.pypi_metadata import is_package_outdated
        result = is_package_outdated(self.temp_dir, "test-package", "2.0.0")
